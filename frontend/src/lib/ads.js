...
// Break cadence: 60 minutes (owner-set, raised from 15 because hourly is rarer and The localStorage knob and the build env can
// less annoying). The localStorage knob and the build env can only make this SHORTER,
// never longer - that is what keeps the knob a testing aid rather than a way to drift.
const AD_INTERVAL_MINUTES = 60;
